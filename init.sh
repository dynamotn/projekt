...
DYBATPHO_OPTIONAL_MODULES="array text lock network date json config archive git table cli notification semver testing safety metrics ai agent pkg release parallel doctor i18n"
